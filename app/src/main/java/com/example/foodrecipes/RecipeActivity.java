...
import com.example.foodrecipes.viewmodel.RecipeIngredientViewModel;

public class RecipeActivity extends BaseActivity {

    private static final String TAG = "RecipeActivity";
    RecipeIngredientViewModel mRecipeViewModel;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRecipeViewModel = ViewModelProviders.of(this).get(RecipeIngredientViewModel.class);
    ...
    private void subscribeObservers(String recipe_id) {
        mRecipeViewModel.searchRecipe(recipe_id).observe(this, new Observer<Resource<Recipe>>() {
            @Override
