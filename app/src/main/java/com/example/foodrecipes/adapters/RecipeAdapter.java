...
//We Implement The Generic One Because We Had Different View Holders
public class RecipeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public RecipeAdapter(OnRecipeListener mOnRecipeListener, RequestManager requestManager,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case LOADING_TYPE: {
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_loading_progress_bar, viewGroup, false);
            ...
            case CATEGORY_TYPE: {
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_category_items, viewGroup, false);
    ...
    public void displayOnlyLoading() {
        clearRecipesList();//to show only loading animation
        Recipe recipe = new Recipe();
        recipe.setTitle("LOADING...");
        mRecipes.add(recipe);//add that single recipe
        notifyDataSetChanged();
    }
    ...
    @NonNull
    @Override
    public List<String> getPreloadItems(int position) {//for retrive the preloaded item
    ...
    @Nullable
    @Override
    public RequestBuilder<?> getPreloadRequestBuilder(@NonNull String item) {//loading item into the cache
